...
{{-- Alert --}}
        ...
        <div id="test" class="grid grid-cols-6 gap-x-4 gap-y-1 max-w-2xl w-screen">
            ...
            <div class="col-span-full mb-3">
                ...
                <a href="{{route('admin.chambres.create')}}" class=" relative bg-blue-500 text-white p-2 rounded text-2xl font-bold">Ajouter Chambre</a>
            </div>
            @foreach ($chambres as $item)
                <!-- Card 1 -->
                <div class="col-span-2">
                    <a href="">
                        <img src="{{ asset('storage/' . $item->image) }}" class="rounded-full brightness-75" />
                    </a>
